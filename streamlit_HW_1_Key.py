...
- Change 5 - size
- Change 6 - Color
- Change 7 - Opacity (thickness)
- Change 8 - Fill
""")
scatter = alt.Chart(df, title="This is my Altair Scatterplot").mark_point(size = 100,opacity=.9,fill='green',color='green').encode(
...
"Pick a random visual, make two visual changes to it, document those changes, and print the plot.  \n"
...
c = alt.Chart(source).mark_bar(color='#17becf').encode(
